    ...
    <div class="container-fluid text-right">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col me-3 d-flex flex-column">
                                ...
                                <div class="progress" role="progressbar" aria-valuenow="{{ $averageTotalProgress }}"
                                     aria-valuemin="0"
                                     aria-valuemax="100">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-group">
                            @forelse($user->tutorials ?? [] as $enrolledTutorial)
                                @php
                                    $userProgress = $user->tutorialProgress()->where('tutorial_id', $enrolledTutorial->id)->first();
        ...
        <div class="row mb-3">
            <div class="card col-12 p-5 text-center bg-body-tertiary rounded-3 text-center position-relative">
                <button type="button"
                        class="position-absolute top-0 start-0 p-3 m-3 btn-close bg-secondary bg-opacity-10 rounded-pill"
                        aria-label="Close" onclick="this.parentElement.parentElement.remove();"></button>
                <h5 class="fs-3 fw-bold">حمایت مالی</h5>
                <p class="lead text-muted">
                    اگر از دوره‌های ما استفاده می‌کنید و می‌خواهید ما را حمایت کنید، می‌توانید با یک مبلغ دلخواه به ما
                    کمک کنید.
                </p>
                <a href="https://zarinp.al/edrisranjbar" target="_blank"
                   class="btn btn-outline-primary btn-w-icon mx-auto">
