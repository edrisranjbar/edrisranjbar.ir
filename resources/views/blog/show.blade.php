    ...
    <div class="row">
        <div class="col-12">
            <article>
                ...
                <figure class="mb-4">
                    <img class="w-75 rounded mx-auto d-block" src="{{ asset('storage/upload/' . $post->thumbnail) }}"
                        alt="{{ $post->title }}">
                </figure>
                <section class="mb-5 fs-4 lh-md fw-light">
                    {!! $post->content !!}
                </section>
                ...
                <section class="d-flex flex-column" id="comments-section">
                    <div class="" id="comment-form">
                        ...
                        <form method="post" action="{{ url('comments') }}" class="mb-5 d-flex flex-column gap-2">
                            ...
                            <textarea class="fs-5 form-control" name="message" id="message" cols="30" rows="10" required
                                maxlength="255">{{ old('message') }}</textarea>
                            <button type="submit" class="btn btn-primary w-fit-content">
                                ارسال نظر
                            </button>
                        </form>
                    </div>
