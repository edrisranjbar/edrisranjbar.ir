...
@section('content')
                    ...
                    <div class="w-100 p-3 bg-white rounded shadow-sm border">
                        ...
                        <div class="mb-3 form-check form-switch">
                            <input class="form-check-input" type="checkbox" role="switch"
                                   id="isFree" name="isFree"
                                   value="true" @checked(old('isFree', isset($lesson) ? $lesson->isFree : null))>
                        ...
                        <div class="mb-3">
                            ...
                            @if (isset($lesson) && $lesson->thumbnail)
                                <div class="mt-2">
                                    ...
                                    <img src="{{ asset('storage/upload/'.$lesson->thumbnail) }}"
    ...
    @if(isset($lesson))
        <div class="modal fade" id="deleteLessonModal" tabindex="-1" role="dialog"
