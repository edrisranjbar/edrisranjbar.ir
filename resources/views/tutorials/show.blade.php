                    ...
                    <form action="{{ route('tutorials.enroll', ['slug' => $tutorial->id]) }}" method="post">
                        ...
                        @else
                            <a class="button button-secondary"
                               href="{{ url("tutorials/" . $tutorial->slug . "/lessons/" . $tutorial->lessons?->first()->id) }}">شروع
                                درس ها</a>
                        @endif
                    </form>
                        ...
                        <div class="accordion-header" id="accordion-{{ $loop->iteration }}">
                            <div class="w-100 d-flex justify-content-between align-items-center">
                                <div class="d-flex flex-row align-items-center">
                                    <svg class="accordion-burger-icon" width="38" height="34" viewBox="0 0 38 34"
                                         fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <path id="Vector"
            ...
            <section class="tutorial-attributes">
                ...
                <div class="row">
                    <div class="col-12 col-md-8">
                        ...
                        <div class="attribute-card">
                            <div class="content">
                                <img class="tutorial-attribute-thumbnail" src="{{ asset('images/practice.png') }}"
                                     alt="">
                                <div class="d-flex flex-column">
                    ...
                    <div class="col-12 col-md-4">
                        <div class="attribute-card h-100">
                            <div class="content">
                                <div class="d-flex flex-column">
                                    <img class="tutorial-attribute-thumbnail mx-auto"
                                         src="{{ asset('images/quiality.png') }}"
