        ...
        <div class="row">
            <div class="widget col-12 col-md-4">
                <img src="{{ asset('images/logo.svg') }}" alt="ادریس رنجبر - توسعه دهنده بک اند وب"
                     style="height: 48px; width: auto;" class="mb-2">
                <p class="fs-5 mb-1 my-text-orange">توسعه دهنده بک اند و مدرس</p>
                <p class="fs-5">
                    من ادریس رنجبر هستم، یه عدد برنامه نویس یا به عبارت دقیق تر، توسعه دهنده بک اند وب. کار اصلیم ساخت و توسعه وب سایت و وب اپلیکیشینه و در کنارش آموزش هم میدم.
                </p>
            </div>
            <div class="widget col-12 col-md-4">
                <p class="title fs-4">دسترسی سریع</p>
            ...
            <div class="widget col-12 col-md-4">
                <p class="title fs-4">اطلاعات تماس</p>
                <div class="social-icons">
                    <a href="https://twitter.com/edris__ranjbar" class="twitter-icon">
                    ...
                    <a href="https://instagram.com/edrisranjbar" class="instagram-icon">
                    ...
                    <a href="mailto:edris.qeshm2@gmail.com" class="email-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0,0,256,256"
                             style="fill:#FFFFFF;">
                            <g fill="#ffffff" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal"><g transform="scale(5.12,5.12)"><path d="M5.91992,6l14.66211,21.375l-14.35156,16.625h3.17969l12.57617,-14.57812l10,14.57813h12.01367l-15.31836,-22.33008l13.51758,-15.66992h-3.16992l-11.75391,13.61719l-9.3418,-13.61719zM9.7168,8h7.16406l23.32227,34h-7.16406z"></path></g></g>
                        </svg>
                    </a>
                    <a href="https://telegram.me/edrisqeshm2" class="telegram-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0,0,256,256"
                             style="fill:#FFFFFF;">
